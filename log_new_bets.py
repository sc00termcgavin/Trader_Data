...
# def add_bet(date, sportsbook, bet_type, selection, odds, stake=0, result="", bonus=False):
#     """
#     Add a new bet to Bet Tracker.
#     - stake is ignored if bonus=True (bonus bet).
#     - Decimal odds, payout, net PnL, cumulative PnL formulas auto-populate.
#     """
#     wb = openpyxl.load_workbook(FILE_PATH)
#     ws = wb["Bet Log"]
...
#     # Formulas
#     # Payout: bonus bets exclude stake return
#     ws[f"J{next_row}"] = f'=IF(G{next_row}="Win",IF(H{next_row}=TRUE,E{next_row}*I{next_row},E{next_row}*I{next_row}),0)'
#     # Net PnL
#     ws[f"K{next_row}"] = f'=J{next_row}-E{next_row}'
#     # Cumulative PnL
#     ws[f"L{next_row}"] = f'=SUM($K$2:K{next_row})'
...
# # 1. Fanatics $10 Moneyline loss (bonus generated $100)
# add_bet(
#     date="9/11/25",
#     sportsbook="Fanatics",
#     bet_type="Moneyline",
...
# # 2. Fanatics $100 bonus bet win on Total Points Odd/Even (won $80)
# add_bet(
#     date="9/11/25",
#     sportsbook="Fanatics",
#     bet_type="Total Points Odd/Even",
...
# # 3. Hard Rock $80 cash bet lost on Total Points Even (lost $80)
# add_bet(
#     date="9/11/25",
...
# # 4. Hard Rock $5 Moneyline Reds vs Padraes (won $0.53)
# add_bet(
#     date="9/11/25",
#     sportsbook="Hard Rock",
#     bet_type="Moneyline",
